                            ...
                            <div class="card-block">
                                <form class="form-horizontal form-material"  enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text"  value="<?php echo $printer->name ?>" class="form-control form-control-line" name="name-printer">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="example-email" class="col-md-12">Merk</label>
                                        <div class="col-md-12">
                                            <input type="text"  value="<?php echo $printer->brand ?>" class="form-control form-control-line" name="brand-printer" id="example-email">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Harga</label>
                                        <div class="col-md-12">
                                            <input type="text" value="<?php echo $printer->price ?>" name="price-printer" class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Stock</label>
                                        <div class="col-md-12">
                                            <input type="number" value="<?php echo $printer->stock ?>" placeholder="" name="stock-printer" class="form-control form-control-line">
                                        </div>
                                    </div>
